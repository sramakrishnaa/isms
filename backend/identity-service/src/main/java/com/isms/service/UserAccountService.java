...
import com.isms.exception.DuplicateResourceException;
...
//	private final PasswordEncoder passwordEncoder;
	...
	public UserResponseDto createUser(RegisterDto dto) {
		...
		String normalizedPhoneNumber = dto.getPhoneNumber().trim();
